    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        <Card 
            ...
            description="Map out goals, solution and key functionalities.">
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card 
            ...
            description="Follow the plan and dive into coding. From initial sketches to polished code."
            >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card 
            ...
            description="Based on the design, I'll translate everything into functional code, building it from the ground up.">
          <CanvasRevealEffect
            animationSpeed={3}
